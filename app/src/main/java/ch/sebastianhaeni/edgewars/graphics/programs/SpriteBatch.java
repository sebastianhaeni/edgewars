...
public class SpriteBatch {
    ...
    public SpriteBatch(int maxSprites, BatchTextProgram program) {
        ...
        this.vertices = new Vertices(program, maxSprites * INDICES_PER_SPRITE, maxSprites * VERTICES_PER_SPRITE);  // Create Rendering Vertices
    ...
    public void endBatch() {
        if (numSprites > 0) {                        // IF Any Sprites to Render
            ...
            GLES20.glUniformMatrix4fv(mProgram.getMVPMatrixHandle(), numSprites, false, uMVPMatrices, 0);
            GLES20.glEnableVertexAttribArray(mProgram.getMVPMatrixHandle());
