...
public class Vertices {
    ...
    private final BatchTextProgram mProgram;
    ...
    public Vertices(BatchTextProgram program, int maxIndices, int maxVertices) {
        mProgram = program;
    ...
    public void bind() {
        ...
        GLES20.glVertexAttribPointer(mProgram.getPositionHandle(), positionCnt,
        ...
        GLES20.glVertexAttribPointer(mProgram.getTexCoordinateHandle(), TEXCOORD_CNT,
                GLES20.GL_FLOAT, false, vertexSize, vertices);
        ESShader.checkGlError("glVertexAttribPointer");
        GLES20.glEnableVertexAttribArray(mProgram.getTexCoordinateHandle());
        ESShader.checkGlError("glEnableVertexAttribArray");

        // bind MVP Matrix index position handle
        vertices.position(positionCnt + TEXCOORD_CNT);
        GLES20.glVertexAttribPointer(mProgram.getMVPMatrixIndexHandle(), MVP_MATRIX_INDEX_CNT,
                GLES20.GL_FLOAT, false, vertexSize, vertices);
        ESShader.checkGlError("glVertexAttribPointer");
        GLES20.glEnableVertexAttribArray(mProgram.getMVPMatrixIndexHandle());
        ESShader.checkGlError("glEnableVertexAttribArray");
    }
    ...
    // R: [none]
    public void unbind() {
        GLES20.glDisableVertexAttribArray(mProgram.getTexCoordinateHandle());
